...
function renderScannerTable(report) {
...
function renderSeveritySections(report) {
...
function renderHtmlReport(report, outputPath) {
    const { summary } = report;
    const verdictClass = summary.critical > 0 || summary.high > 0
        ? 'verdict-fail'
        : summary.medium > 0 || summary.low > 0
            ? 'verdict-warn'
            : 'verdict-pass';
    const verdictText = summary.critical > 0 || summary.high > 0
