...
```bash
npx web-secure-verification scan
```
...
npx web-secure-verification scan --format html --output report.html

# JSON file — for scripts or dashboards
npx web-secure-verification scan --format json --output report.json

# Markdown — paste into a GitHub PR comment
npx web-secure-verification scan --format markdown --output report.md

# SARIF — upload to GitHub Code Scanning
npx web-secure-verification scan --format sarif --output results.sarif
```
...
npx web-secure-verification scan --path ./my-app

# Only show high and critical issues
npx web-secure-verification scan --severity high

# Skip certain checks
npx web-secure-verification scan --skip outdated,license,bundle

# Auto-fix issues interactively after the scan
npx web-secure-verification scan --fix

# See all available scanners
npx web-secure-verification list-scanners
```
